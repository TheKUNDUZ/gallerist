...
import com.alikunduz.jwt.JWTService;
import com.alikunduz.model.RefreshToken;
import com.alikunduz.model.User;
import com.alikunduz.repository.RefreshTokenRepository;
   ...
   private RefreshToken createRefreshToken(User user){
    ...
    public AuthResponse authenticate(AuthRequest input) {
       ...
       try {
           ...
           RefreshToken refreshToken = createRefreshToken(opUser.get());
